...
const DashboardScreen = ({ navigation, dashboardFilterDate, setDashboardFilterDate, dashboardData, isLoading, topFiveSubIds }) => {
    const { showDatePicker, setShowDatePicker, onRequestClose, onSelectDateRange, dateFilter }= useDashboard(setDashboardFilterDate);
    ...
    return (
        <View bg="white" width="100%" height={'100%'}>
            ...
            <View style={{ flex: 1, marginTop: '10%',  marginLeft: '4%' , marginRight: '4%'}}>
