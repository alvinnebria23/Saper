...
import { Alert, Avatar, Button, Center, Heading, Icon, Input, Modal,Row, ScrollView, Text } from 'native-base';
    ...
    <ScrollView style={{ flex: 1 }} showsVerticalScrollIndicator={false}>
      ...
      <View style={{ marginTop: "10%"}}>
        ...
        <View style={{ flex: 2, marginRight: 30, marginLeft: 30, marginTop: 30, marginBottom: '25%' }}>
          ...
          <Center mt={'5%'}>
            <Text color={'gray.500'}>{`Do you need support? \nVisit our faceboook page.`}</Text>
