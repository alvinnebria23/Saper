...
export const REGISTRATION_SUCESS = {
    header: 'Success',
    body: 'You have successfully registered. We sent a 6-digit verification code to your email address to verify your email when you login.',
    isOpen: true,
};
...
export const NETWORK_ERROR = { fieldName: '', errorMessage: 'NETWORK ERROR'};
...
export const TERMS_AND_CONDITIONS_OBJECT = {
