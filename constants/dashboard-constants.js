...
export const EMPTY_DASHBOARD_VALUE = [
  { type: 'amount', id: 1, name: "Total Commission", value: 0},
  { type: 'number', id: 2, name: "Total Order", value: 0},
  { type: 'amount', id: 3, name: "Total Amount Order", value: 0},
  { type: 'amount', id: 4, name: "Shopee Commission", value: 0},
  { type: 'amount', id: 5, name: "Seller Commission", value: 0},
  { type: 'amount', id: 6, name: "Unpaid", value: 0},
  { type: 'amount', id: 7, name: "Completed", value: 0},
  { type: 'amount', id: 8, name: "Pending", value: 0},
];
